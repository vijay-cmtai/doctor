      ...
      <main className="flex-1 py-8 px-4 md:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose max-w-none text-gray-700">
            <p>Welcome to Doctor Directory!</p>
            <p>
              These terms and conditions outline the rules and regulations for the use of Doctor Directory's Website,
              located at https://www.doctordirectory.com.
            </p>
            <p>
              By accessing this website we assume you accept these terms and conditions. Do not continue to use Doctor
              Directory if you do not agree to take all of the terms and conditions stated on this page.
            </p>
            <p>
              ...
              provision of the Company's stated services, in accordance with and subject to, prevailing law of India.
            ...
            <h2>Cookies</h2>
            <p>
              We employ the use of cookies. By accessing Doctor Directory, you agreed to use cookies in agreement with
              the Doctor Directory's Privacy Policy.{" "}
            </p>
            <p>
            ...
            <h2>License</h2>
            <p>
              Unless otherwise stated, Doctor Directory and/or its licensors own the intellectual property rights for
              all material on Doctor Directory. All intellectual property rights are reserved. You may access this from
              Doctor Directory for your own personal use subject to restrictions set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from Doctor Directory</li>
              <li>Sell, rent or sub-license material from Doctor Directory</li>
              <li>Reproduce, duplicate or copy material from Doctor Directory</li>
              <li>Redistribute content from Doctor Directory</li>
            </ul>
            <p>
            ...
            <p>
              ...
              certain areas of the website. Doctor Directory does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views and opinions of Doctor Directory,its
              agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, Doctor Directory shall not be liable for the
              Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or
              posting of and/or appearance of the Comments on this website.
            </p>
            <p>
              Doctor Directory reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>
              ...
              absence of Doctor Directory; and (d) the link is in the context of general resource information.
            </p>
            <p>
            ...
            <p>
              ...
              website, you must inform us by sending an e-mail to Doctor Directory. Please include your name, your
            ...
            <p>
              No use of Doctor Directory's logo or other artwork will be allowed for linking absent a trademark license
              agreement.
            </p>
            <h2>iFrames</h2>
            <p>
