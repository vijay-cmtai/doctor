          ...
          <div className="prose max-w-none text-gray-700">
            ...
            <ul>
              ...
              <li>
                ...
                or &quot;Our&quot; in this Agreement) refers to Doctor Directory.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Doctor Directory, accessible from{" "}
                <a href="https://www.doctordirectory.com" rel="noreferrer external nofollow noopener" target="_blank">
                  https://www.doctordirectory.com
                </a>
              </li>
              <li>
            ...
            <ul>
              <li>By email: support@doctordirectory.com</li>
            </ul>
          </div>
        </div>
      </main>
